# 数値解析 第13回 『常微分方程式の数値解法 (2)』

このリポジトリには、2020年度後期に三重大学工学部で開講された『数値解析』の第13回の講義資料が含まれています。

## 第13回授業の講義動画

[![YouTube](https://img.shields.io/badge/YouTube-%23FF0000.svg?style=for-the-badge&logo=YouTube&logoColor=white)](https://youtu.be/z_I-ht9u_L8)

## ファイル説明

- `infona2020_slide_13.tex`
    - BEAMERクラスを使ったスライドのLaTeXコード
- `infona2020_slide_13.pdf`
    - 上記LaTeXコードから生成したスライドのPDFファイル
    - LaTeXコードおよびPDFファイルはOverleafで作成 [[Overleafプロジェクト](https://www.overleaf.com/read/pjymmthhrbyc)]
- `report_13.pdf`
    - 動画内で使用している第13回レポートのPDFファイル
    - 前半分のページは授業で穴埋めする前の状態
    - 後半分のページは穴埋め部分を埋めた状態
    - 書き込み前のLaTeXコードはOverleafで作成 [[Overleafプロジェクト](https://www.overleaf.com/read/fhhcfdhrqhvf)]
